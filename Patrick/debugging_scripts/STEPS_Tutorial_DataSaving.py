...
mesh = TetMesh.LoadGmsh('/home/pb/steps_cell_signaling/Patrick/meshes/square_9k.msh', scale=1e-6)
with mesh:
...
with XDMFHandler('/home/pb/steps_cell_signaling/Patrick/saved_objects/testing/Brusselator_square') as hdf:
