...
sm = SimManager(parameters=p,
                ...
                endt = 1,
                mesh_path = "/home/evelyn/shared_files/signaling_repo/steps_cell_signaling/Patrick/meshes/.inp/kugel04.inp",
                save_file ="saved_objects/initial_run/parallel_run", # no .h5 ending needs to be added
                parallel = True,
