...
sm = SimManager(parameters=p,
                ...
                endt = 1,
                mesh_path = "/home/evelyn/shared_files/signaling_repo/steps_cell_signaling/Patrick/meshes/.inp/kugel_7.5.inp",
                save_file ="saved_objects/initial_run/parallel_run.h5",
                parallel = True,
